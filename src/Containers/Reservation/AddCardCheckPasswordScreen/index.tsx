...
interface PropTypes {
  route: RouteProp<MainStackParamList, 'AddCardCheckPasswordScreen'>;
}

const AddCardCheckPasswordScreen = ({ route }: PropTypes) => {
  ...
  useEffect(() => {
    if (validation) {
      dispatch(ReservationActions.fetchReservationCard({ ...cardInfo, paymentPwd }));
    }
  }, [validation]);
...
export default AddCardCheckPasswordScreen;
