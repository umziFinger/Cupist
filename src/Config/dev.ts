const dev = {
  ...
  // 예약유의사항
  NORMAL_CAUTION_INFO: `ㅁ 시간제 볼링 정책 등록\n시간제 볼링은 1시간 단위로 예약하여 인원, 게임수 상관없이 무제한으로 즐길 수 있는 상품입니다.\n※ 예약 시간은 게임 전 준비시간과 게임 후 정리시간이 포함된 시간입니다./n※ 사전 레인지정 불가능합니다.\n※ 추가 문의 사항은 예약한 볼링장으로 연락부탁드립니다.`,
  FREE_CAUTION_INFO: `ㅁ 자유볼링 정책 등록\n자유볼링은 정해진 시간동안 무제한으로 즐길 수 있는 상품입니다.\n단, 공유 레인으로 해당 시간 상품을 구매하신 볼러분들과 함께 칠 수 있습니다.\n예약시간을 잘 지켜서 동일시간에 참여하는 볼러들에게 에티켓을 지켜주세요!\n※ 예약 시간은 게임 전 준비시간과 게임 후 정리시간이 포함된 시간입니다.\n※ 사전 레인지정 불가능합니다.\n※ 추가 문의 사항은 예약한 볼링장으로 연락부탁드립니다.`,
