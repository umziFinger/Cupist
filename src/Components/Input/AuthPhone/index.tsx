...
const InputAuthPhone = forwardRef<TextInput, InputAuthPhoneProps>(
  ({ onChangeText, value, onPressAuth, isPhoneValid }: InputAuthPhoneProps, ref) => {
...
InputAuthPhone.displayName = 'InputAuthPhone';
